...
public interface StopMapper {
    ...
    int Add(@Param("stop_name")String stop_name, @Param("latitude")double latitude, @Param("longitude")double longitude);//添加站点信息
    int Upd(@Param("station_id")int station_id ,@Param("stop_name")String stop_name,@Param("latitude")double latitude,@Param("longitude")double longitude);//根据站点id来更新站点信息
